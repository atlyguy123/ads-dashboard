...
const OverviewROASSparkline = React.memo(({ 
  dateRange,
  breakdown = 'all',
  refreshTrigger = 0,
  width = 120,
  ...
  const getROASPerformanceColor = (roas, conversions = 0) => {
    ...
    if (roasValue >= 1.0 && roasValue < 1.25) return 'text-green-400';
    if (roasValue >= 1.25 && roasValue < 1.5) return 'text-blue-400';
...
export default OverviewROASSparkline; 